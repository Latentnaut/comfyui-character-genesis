...
### Elite Casting Capabilities
- **Character Genesis Node** - Advanced character formulation using high-fashion typologies (Commercial, Editorial/Gaunt, Unconventional/Alien, Fluid/Androgynous).
- **Professional Descriptors Toggle** - Optionally inject rich, vetted professional casting descriptor texts straight into your prompt.
